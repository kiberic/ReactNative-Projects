...
export default function ToDoItem({ todo, onPress, onEdit }: Props) {
    ...
    <View style={styles.itemContainer}>
      ...
      <View style={styles.btnContainer}>
        <Pressable
          ...
          onPress={() => onPress(todo)}   // ✅ теперь вызывается правильно
          onPressIn={() => setPressed(true)}
          onPressOut={() => setPressed(false)}
        >
          <Text style={styles.buttonTxt}>{pressed ? "Отпустить" : "Go by link"}</Text>
        </Pressable>
        {isEdit ? (
          <Pressable
          ...
          >
            <Text style={styles.buttonTxt}>Редактировать задачу</Text>
          </Pressable>
        )}
      </View>
    </View>
